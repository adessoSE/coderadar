...
/**
 * The methods of this class are copied from the StringUtils class of the spring framework to avoid the
 * full dependency to the spring framework. Big thanks to the Spring team!
 */
