...
public class Annotator {
    ...
    private final AnalyzerPluginRegistry analyzerPluginRegistry;
    ...
    public Annotator(Properties properties, VcsType vcsType, String repositoryUrl, File localRepositoryFolder) {
        ...
        this.analyzerPluginRegistry = new AnalyzerPluginRegistry();
        try {
            analyzerPluginRegistry.initializeAnalyzers(properties);
    ...
    public void annotate() {
        try {
            ...
            analyzerPluginRegistry.destroyAnalyzers();
        }
    }
    ...
    private void annotateRepository(Git gitClient) {
        ...
        walker.walk(gitClient, analyzerPluginRegistry.getRegisteredFileAnalyzers(), processor);
    }
