...
import org.wickedsource.coderadar.analyzer.checkstyle.CheckstyleFileAnalyzerPlugin;
...
public class AnnotatorManualTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        properties.put(CheckstyleFileAnalyzerPlugin.class.getName() + ".configLocation", "src/test/resources/checkstyle.xml");
