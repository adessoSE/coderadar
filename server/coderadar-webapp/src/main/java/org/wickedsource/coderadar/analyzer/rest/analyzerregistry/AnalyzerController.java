...
public class AnalyzerController {
    ...
    public ResponseEntity<PagedResources<AnalyzerResource>> listAnalyzers(@PageableDefault Pageable pageable, PagedResourcesAssembler pagedResourcesAssembler) {
        ...
        PagedResources<AnalyzerResource> pagedResources = pagedResourcesAssembler.toResource(analyzerPage, assembler);
