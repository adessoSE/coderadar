...
import org.wickedsource.coderadar.metric.domain.qualityprofile.QualityProfile;
import org.wickedsource.coderadar.metric.domain.qualityprofile.QualityProfileMetric;
...
public class QualityProfileResourceAssembler extends ResourceAssemblerSupport<QualityProfile, QualityProfileResource> {
    ...
    public QualityProfileResource toResource(QualityProfile entity) {
        ...
        resource.add(linkTo(methodOn(QualityProfileController.class).getQualityProfile(entity.getId(), project.getId())).withRel("self"));
