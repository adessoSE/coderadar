...
public class FileScanner {
    ...
    @Autowired
    public FileScanner(LocalGitRepositoryUpdater updater, CommitRepository commitRepository, GitCommitFinder commitFinder, CommitLogEntryRepository logEntryRepository) {
