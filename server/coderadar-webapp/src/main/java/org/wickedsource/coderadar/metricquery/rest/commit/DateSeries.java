...
public class DateSeries<T extends Comparable> extends Series<T, Long> {
    ...
    @JsonIgnore
    private Map<T, Point<T, Long>> pointsByDate = new HashMap<>();
    ...
    /**
     * Goes through all points currently in this series. If the numeric value (Y coordinate) of a point is NULL,
     * its value is set to the value of the chronologically previous point.
     */
