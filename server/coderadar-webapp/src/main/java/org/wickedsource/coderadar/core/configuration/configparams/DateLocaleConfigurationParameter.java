...
/**
 * Configures the locale to use for calculating dates (like the number of a week in a year, which
    ...
    try {
      ...
      return Collections.singletonList(
          new ParameterValidationError(
              String.format(
                  "'%s' is an invalid Locale. Correct format would be something like 'en_US' (language_country).",
                  envProperty())));
    }
  }
