...
/**
 * Service that associates files with modules. The methods of this service will run asynchronously since it may take
 * a while associating all files in the database with a certain module.
 */
@Service
public class ModuleAssociationService {
    ...
    /**
     * Disassociates all files of the given module from that module before associating the given module with all files whose path is within the path of the module.
     */
