...
public class AnalyzingStrategyResourceAssembler
    extends ResourceAssemblerSupport<AnalyzingStrategy, AnalyzingStrategyResource> {
  ...
  public AnalyzingStrategyResource toResource(AnalyzingStrategy entity) {
    AnalyzingStrategyResource resource =
        new AnalyzingStrategyResource(entity.getFromDate(), entity.isActive());
    resource.add(
        linkTo(methodOn(AnalyzingStrategyController.class).getAnalyzingStrategy(projectId))
            .withRel("self"));
    resource.add(
  ...
  public AnalyzingStrategy updateEntity(
      AnalyzingStrategy entity, AnalyzingStrategyResource resource, Project project) {
