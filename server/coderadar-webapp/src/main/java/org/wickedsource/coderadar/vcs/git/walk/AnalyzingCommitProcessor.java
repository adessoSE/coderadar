...
public class AnalyzingCommitProcessor implements CommitProcessor {
    ...
    private void walkFilesInCommit(Git gitClient, RevCommit commit, List<SourceCodeFileAnalyzerPlugin> analyzers, MetricsProcessor metricsProcessor) throws IOException {
