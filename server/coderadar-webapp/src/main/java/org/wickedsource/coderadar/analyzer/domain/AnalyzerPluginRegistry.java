...
public class AnalyzerPluginRegistry {
    ...
    private Map<String, Class<? extends SourceCodeFileAnalyzerPlugin>> sourceCodeFileAnalyzerPlugins = new HashMap<>();

    /**
     * Constructs a new AnalyzerPluginRegistry. This is a very expensive operation since the AnalyzerPluginRegistry
     * scans the whole classpath for implementations of the SourceCodeFileAnalyzer interface!
     */
    ...
    /**
     * Creates a new instance of the analyzer with the specified name and invokes its configure method.
     * The analyzer must implement the ConfigurableAnalyzerPlugin interface, otherwise an IllegalArgumentException
     * will be thrown.
     *
     * @param analyzerName      the name of the analyzer to instantiate
     * @param configurationFile the configuration file to be passed into the analyzer. If the configuration file
     *                          is not valid, an IllegalArgumentException will be thrown.
     */
    public SourceCodeFileAnalyzerPlugin createAnalyzer(String analyzerName, byte[] configurationFile) {
