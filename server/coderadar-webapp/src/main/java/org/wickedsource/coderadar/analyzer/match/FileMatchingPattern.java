...
public class FileMatchingPattern {
     ...
     * <ul>
     * <li>false, if the filepath does not match any include pattern</li>
     * <li>false, if the filepath matches at least one exclude pattern</li>
     * <li>true, if the filepath matches at least one include pattern and no exclude pattern</li>
     * </ul>
     *
