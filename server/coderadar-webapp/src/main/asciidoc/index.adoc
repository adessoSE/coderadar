...
=== Structure
include::{snippets}/strategy/set/request-fields.adoc[]

=== Hypermedia Links
include::{snippets}/strategy/set/links.adoc[]

=== Setting a Project's Analyzing Strategy

==== Example Request
include::{snippets}/strategy/set/http-request.adoc[]

==== Example Response
include::{snippets}/strategy/set/http-response.adoc[]
