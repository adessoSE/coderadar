...
=== Adding / Updating an AnalyzerConfiguration

==== Example Request
include::{snippets}/analyzerConfiguration/post/curl-request.adoc[]

==== Example Response
include::{snippets}/analyzerConfiguration/post/http-response.adoc[]

=== Deleting an AnalyzerConfiguration from a Project

=== Listing a Project's AnalyzerConfigurations
