...
== User Management
anchor:chapter-configure[]
This section describes available operation for user management

=== Registration
To use the functionality of the coderadar you have to register a user.
You need to define a username and a password. Password will be send as
