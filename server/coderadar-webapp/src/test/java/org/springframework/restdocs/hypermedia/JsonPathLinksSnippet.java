...
/**
 * Extension of the default LinksSnippet to document hypermedia links contained
 * in a response that allows extraction of links not only in the root of a JSON document
 * but within a certain JSON path of the document.
 */
