...
public class MetricsTreeResourceTest {
    ...
    public void addedModulesAreNestedCorrectly() {
        MetricsTreeResource<CommitMetricsPayload> tree = new MetricsTreeResource<>(null, null, new CommitMetricsPayload(), MetricsTreeNodeType.MODULE);
        tree.addModules(Arrays.asList("server/foo/module1",
                ...
                "server/foo/bar/module6/submodule7"), (module -> new CommitMetricsPayload()), (module -> MetricsTreeNodeType.MODULE));
