        ...
        mvc().perform(post("/projects/1/strategy")
                ...
                .andDo(document("strategy/set",
                        ...
                        requestFields(
                                ...
                                fields.withPath("rescan").description("Set this to true when updating an AnalyzingStrategy if you want to delete all existing analysis results and restart analysis with the new strategy. You will get an error response if you try rescanning a project while there are running or queued analysis jobs (i.e. when the last scan over all commits is not yet finished)."),
