...
public class GetFilePatternsFromProjectController {
  ...
  @Autowired
  public GetFilePatternsFromProjectController(
      GetFilePatternFromProjectUseCase getFilePatternFromProjectUseCase) {
  ...
  public ResponseEntity<List<FilePattern>> getFilePatterns(@PathVariable Long projectId) {
    return new ResponseEntity<>(
        getFilePatternFromProjectUseCase.getFilePatterns(projectId), HttpStatus.OK);
  }
}
