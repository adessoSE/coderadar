...
public class AddAnalyzerConfigurationControllerTest {
    ...
    @Mock
    private AddAnalyzerConfigurationUseCase addAnalyzerConfigurationUseCase;
    ...
    public void returnsIdOneForNewAnalyzerConfiguration() {
        AddAnalyzerConfigurationCommand command = new AddAnalyzerConfigurationCommand(5L, "analyzer", true);
