...
public class Finding {
     ...
     * @param charStart the position of the character where the finding starts, starting with 1 for the first character of the line.
     * @param charEnd   the position of the character where the finding ends, starting with 1 for the first character of the line.
     */
