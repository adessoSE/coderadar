...
public class FindbugsReportXsdValidator {
     ...
     * @return list of validation errors. Validation is successful if this list is empty.
     */
    public List<SAXParseException> validate(InputStream findbugsReport, final ValidationLevel validationLevel) {
        try {
            ...
            if (xsdInputStream == null) {
                throw new IllegalStateException("Could not find XSD file in classpath (bugcollection.xsd)!");
            }
