...
public class ServiceLoaderTest {
  ...
  public void analyzerIsRegisteredWithServiceLoader() {
    ServiceLoader<SourceCodeFileAnalyzerPlugin> loader = ServiceLoader.load(SourceCodeFileAnalyzerPlugin.class,  CheckstyleSourceCodeFileAnalyzerPlugin.class.getClassLoader());
