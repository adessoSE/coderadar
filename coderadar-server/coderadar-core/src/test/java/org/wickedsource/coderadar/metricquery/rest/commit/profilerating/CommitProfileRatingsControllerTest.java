...
public class CommitProfileRatingsControllerTest extends ControllerTestTemplate {
  ...
  public void queryCommitProfiles() throws Exception {
    ...
    MvcResult result =
        mvc()
            .perform(
                get("/projects/1/profileratings/perCommit")
                ...
                document(
                    ...
                    requestFields(
                        ...
                        requestFields
                            .withPath("profiles")
                            .description(
                                "List of names of the quality profiles whose ratings you want to query."))))
            .andReturn();

    CommitProfileRatingsOutputResource output =
        fromJson(
            result.getResponse().getContentAsString(), CommitProfileRatingsOutputResource.class);
