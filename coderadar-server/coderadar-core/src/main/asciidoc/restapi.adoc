...
=== Users with OAuth 2.0
Coderader supports also OAuth 2.0 authentication. If the system does not find
an Authorization HTTP Header, it tries to proceed OAuth2 Authentication with Github.
