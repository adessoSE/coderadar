...
public class AddAnalyzerConfigurationService implements AddAnalyzerConfigurationPort {
    ...
    @Autowired
    public AddAnalyzerConfigurationService(GetProjectRepository getProjectRepository, AddAnalyzerConfigurationRepository addAnalyzerConfigurationRepository) {
