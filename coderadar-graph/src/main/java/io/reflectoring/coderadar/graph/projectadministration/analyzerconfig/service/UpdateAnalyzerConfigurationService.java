...
public class UpdateAnalyzerConfigurationService implements UpdateAnalyzerConfigurationPort {
    ...
    @Autowired
    public UpdateAnalyzerConfigurationService(GetAnalyzerConfigurationsFromProjectRepository getAnalyzerConfigurationsFromProjectRepository, UpdateAnalyzerConfigurationRepository updateAnalyzerConfigurationRepository) {
    ...
    public void update(AnalyzerConfiguration entity) {
        ...
        if (peristedAnalyzerConfiguration.isPresent()) {
            ...
            throw new AnalyzerConfigurationNotFoundException("Can't update a non-existing analyzer configuration.");
        }
    }
}
