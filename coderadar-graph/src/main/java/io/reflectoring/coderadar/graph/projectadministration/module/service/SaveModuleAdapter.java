...
public class SaveModuleAdapter implements SaveModulePort {
    ...
    public SaveModuleAdapter(GetProjectRepository getProjectRepository, CreateModuleRepository createModuleRepository, ListModulesOfProjectRepository listModulesOfProjectRepository) {
    ...
    @Override
    public Long saveModule(Module module, Long projectId) throws ModuleAlreadyExistsException, ModulePathInvalidException, ProjectIsBeingProcessedException {
