...
class RemoveUsersFromTeamControllerTest extends UnitTestTemplate {
  ...
  void testRemoveTeamFromProjectThrowsExceptionWhenTeamNotFound() {
    ...
    Assertions.assertThrows(
        TeamNotFoundException.class, () -> testController.removeUsersFromTeam(1L, jsonListWrapper));
  }
  ...
  void testRemoveTeamFromProjectThrowsExceptionWhenUserNotFound() {
    ...
    JsonListWrapper<Long> jsonListWrapper = new JsonListWrapper<>(Collections.singletonList(2L));
    Assertions.assertThrows(
        UserNotFoundException.class, () -> testController.removeUsersFromTeam(1L, jsonListWrapper));
  }
}
