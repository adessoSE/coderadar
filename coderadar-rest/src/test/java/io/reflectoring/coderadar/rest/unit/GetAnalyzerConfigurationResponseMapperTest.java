...
public class GetAnalyzerConfigurationResponseMapperTest {
    ...
    public void testAnalyzerConfigurationResponseMapper() {
        ...
        List<GetAnalyzerConfigurationResponse> responses = GetAnalyzerConfigurationResponseMapper.mapAnalyzerConfigurations(analyzerConfigurations);
    ...
    public void testModuleResponseSingleMapper() {
        AnalyzerConfiguration analyzerConfiguration = new AnalyzerConfiguration(1L, "testAnalyzer1", true);
        GetAnalyzerConfigurationResponse response = GetAnalyzerConfigurationResponseMapper.mapAnalyzerConfiguration(analyzerConfiguration);
