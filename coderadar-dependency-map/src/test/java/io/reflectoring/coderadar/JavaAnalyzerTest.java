...
public class JavaAnalyzerTest {
     ...
     *
     * missing:
     *   RandomClass3, Annotation2, Annotation3
     */
    @Test
    public void testGetValidImports() {
        ...
        Assertions.assertEquals("org.wickedsource.dependencytree.example.somepackage.CoreDependencyTest5", imports.get(5));
        Assertions.assertEquals("org.wickedsource.dependencytree.example.wildcardpackage.*", imports.get(6));
        ...
        Assertions.assertEquals("org.wickedsource.dependencytree.example.somepackage.FullyClassifiedDependencyTest", imports.get(16));
    ...
    public void testGetFirstSeparator() {
        ...
        // should return first '(' after ClassQ.isEmpty, because there is no potential import between begin and all separators before that '('
        Assertions.assertEquals(19, test.indexOf(analyzer.getFirstSeparator(test)));
    }

    @Test
    public void testDependencyStrings() {
        String line = "import org.wickedsource.dependencytree.sbdfjksbdf; import org.wickedsource.dependencytree.fhzgkobd;";
        // should return first '(' after ClassQ.isEmpty, because there is no potential import between begin and all separators before that '('
    ...
    public void testImportDependencyStrings() {
        String line = "ClassP b = ((ClassQ.isEmpty() && classR.isEmpty()) || classS.isEmpty || ((classT.size > classU.size) && classV.size < classW.size)) ? ClassX.get : classY.get;";
        // should return first '(' after ClassQ.isEmpty, because there is no potential import between begin and all separators before that '('
