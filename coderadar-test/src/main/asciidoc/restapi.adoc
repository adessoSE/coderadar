...
==== Registering a User
// TODO should password really be send as plaintext or is it in plaintext but encrypted?
...
// TODO shouldn't it be a hash which is sent to the server?
...
. <<start-analyzing-job, Start an Analyzing Job>> for your project. coderadar will start to analyze all files
...
include::{snippets}/filepatterns/create/request-fields.adoc[]
...
include::{snippets}/filepatterns/update/http-request.adoc[]

===== Example Response

include::{snippets}/filepatterns/update/http-response.adoc[]
...
Analyzing Jobs can be started for a project in coderadar. By default a Project's codebase is not analyzed.
To analyze the codebase an Analyzing Job has to be executed.

[NOTE]
The execution of an Analyzing Job may take some time. This is especially true for larger projects.
Spring Boot for example takes about 30 minutes. This may vary with different hardware specifications.

==== Starting an Analyzing Job
anchor:start-analyzing-job[]

===== Structure

include::{snippets}/analyzing-job/start/request-fields.adoc[]

===== Example Request

include::{snippets}/analyzing-job/start/http-request.adoc[]

===== Example Response

include::{snippets}/analyzing-job/start/http-response.adoc[]

==== Retrieving an Analyzing Job status

===== Example Request

include::{snippets}/analyzing-job/status/http-request.adoc[]

===== Example Response

include::{snippets}/analyzing-job/status/http-response.adoc[]

==== Resetting an Analyzing Job

===== Example Request

include::{snippets}/analyzing-job/reset/http-request.adoc[]

===== Example Response

include::{snippets}/analyzing-job/reset/http-response.adoc[]
...
[NOTE]
=====
Metric values will become available as soon as an <<start-analyzing-job,Analyzing Job>> starts for your project.
