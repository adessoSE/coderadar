...
=== List all contributors for a single File

==== Example Request

include::{snippets}/contributors/list/file/http-request.adoc[]

==== Example Response

include::{snippets}/contributors/list/file/http-response.adoc[]
...
include::{snippets}/metrics/criticalFiles/request-fields.adoc[]

==== Example Request

include::{snippets}/metrics/criticalFiles/http-request.adoc[]

==== Example Response

include::{snippets}/metrics/criticalFiles/http-response.adoc[]
