...
This is the directory project will be cloned to. It's path can be adjusted by changing the following property:
...
To start the Coderadar UI, you must first build it. This requires having NPM installed, going to the `coderadar-ui` directory and
